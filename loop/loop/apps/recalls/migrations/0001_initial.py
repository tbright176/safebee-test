    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('consequence_summary', models.TextField()),
                ('defect_summary', models.TextField()),
                ('food_type', models.CharField(max_length=1, verbose_name='Food Recall Type')),
            ],
            options={
                'abstract': False,
            },
