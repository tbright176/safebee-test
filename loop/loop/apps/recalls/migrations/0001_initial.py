    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('component_description', models.TextField(verbose_name='component description')),
                ('manufacturer', models.CharField(max_length=100, verbose_name='manufacturer')),
                ('manufacturing_begin_date', models.DateField(null=True, verbose_name='manufacturing begin date', blank=True)),
                ('manufacturing_end_date', models.DateField(null=True, verbose_name='manufacturing end date', blank=True)),
                ...
                ('year', models.PositiveSmallIntegerField(max_length=4, null=True, verbose_name='year', blank=True)),
