    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('primary_image', models.ForeignKey(related_name=b'core_infographic_primary_image', on_delete=django.db.models.deletion.SET_NULL, blank=True, to='asset_manager.Image', null=True)),
                ('promo_image', models.ForeignKey(related_name=b'core_infographic_promo_image', on_delete=django.db.models.deletion.SET_NULL, blank=True, to='asset_manager.Image', help_text=b'Optional. If left blank, the promo image will be automatically created from the primary image.', null=True)),
                ('secondary_author', models.ForeignKey(related_name=b'+', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
                ('social_image', models.ForeignKey(related_name=b'core_infographic_social_image', on_delete=django.db.models.deletion.SET_NULL, blank=True, to='asset_manager.Image', help_text=b'Optional. If left blank, the social image will be automatically created from the primary image.', null=True)),
