    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(default=b'D', max_length=2, choices=[(b'D', b'Draft'), (b'M', b'Moderate 0'), (b'M1', b'Moderate 1'), (b'M2', b'Moderate 2'), (b'F', b'Final Review'), (b'R', b'Ready for Pub'), (b'P', b'Published'), (b'S', b'Scheduled'), (b'T', b'Trash')])),
                ...
                ('primary_image', models.ForeignKey(related_name=b'core_tipslist_primary_image', on_delete=django.db.models.deletion.SET_NULL, blank=True, to='asset_manager.Image', null=True)),
                ('promo_image', models.ForeignKey(related_name=b'core_tipslist_promo_image', on_delete=django.db.models.deletion.SET_NULL, blank=True, to='asset_manager.Image', help_text=b'Optional. If left blank, the promo image will be automatically created from the primary image.', null=True)),
                ('secondary_author', models.ForeignKey(related_name=b'+', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
                ('social_image', models.ForeignKey(related_name=b'core_tipslist_social_image', on_delete=django.db.models.deletion.SET_NULL, blank=True, to='asset_manager.Image', help_text=b'Optional. If left blank, the social image will be automatically created from the primary image.', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ForeignKey(related_name=b'core_tipslistitem_primary_image', on_delete=django.db.models.deletion.SET_NULL, blank=True, to='asset_manager.Image', null=True)),
                ('tips_list', models.ForeignKey(to='core.TipsList')),
            ],
            options={
                'ordering': ['order'],
            },
        ...
        migrations.AlterUniqueTogether(
            name='tipslistitem',
            unique_together=set([('tips_list', 'title')]),
        ),
        migrations.AlterUniqueTogether(
            name='tipslist',
