...
MIDDLEWARE_CLASSES = (
    ...
    'loop.flatpages.middleware.FlatpageFallbackMiddleware',
...
TEMPLATE_CONTEXT_PROCESSORS = TCP + (
    ...
    'loop.core.context_processors.site_processor',
    'loop.core.context_processors.debug_status',
)
...
ROOT_URLCONF = 'safebee.urls'

WSGI_APPLICATION = 'safebee.wsgi.application'
...
SUIT_CONFIG = {
    'ADMIN_NAME': 'SafeBee',
    'LIST_PER_PAGE': 100,
    'MENU_EXCLUDE': ('loop.core.streamitem',),
}

# Easy Thumbnail settings
THUMBNAIL_ALIASES = {
    'loop.asset_manager.Image': {
